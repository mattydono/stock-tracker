...
const Root = ({ 
    ...
    return (
        <RootContainer>
            ...
            <Chart {...chart} ticker={ticker} open={keyStats.isUSMarketOpen} latest={keyStats.latestPrice} updateChartPrices={updateChartPrices} updateChartRange={updateChartRange} />
            <News news ={news}/>
            <KeyStats {...keyStats}/>
            <CompanyContainer>
